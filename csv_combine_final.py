...
f = open('/home/hotsea/IRS/Revised_Filer_1_2014.csv', 'w+')
...
for file in files:
	...
	preparer = dom.getElementsByTagName('PreparerFirmGrp')
	preparer1 = dom.getElementsByTagName('PreparerFirm')
	...
	if (len(preparer) < 1) and (len(preparer1) < 1):
